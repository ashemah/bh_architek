...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.instance_name'
        db.delete_column(u'core_service', 'instance_name')

        # Adding field 'Service.container_name'
        db.add_column(u'core_service', 'container_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Service.instance_name'
        db.add_column(u'core_service', 'instance_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Service.container_name'
        db.delete_column(u'core_service', 'container_name')
